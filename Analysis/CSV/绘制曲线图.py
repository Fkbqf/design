...
if __name__ == '__main__':
    ...
    my_csvs = [
        {'name': 'AlexNet',
         'path': 'AlexNet_43351121975_metrics.csv'},

        {'name': 'ConvNeXt',
         'path': 'ConvNeXt_tiny_43351133175_metrics.csv'},

        {'name': 'DenseNet',
         'path': 'DenseNet121_43351154400_metrics.csv'},

        {'name': 'EfficientNet',
         'path': 'EfficientNetV2_S_43351215875_metrics.csv'},

        {'name': 'GoogLeNet',
         'path': 'GoogLeNet_43351265275_metrics.csv'},

        {'name': 'Improve_ConvNeXt',
         'path': 'Improve_ConvNeXt_43351089225_metrics.csv'},

        {'name': 'MobileNet',
         'path': 'MobileNet_V3_Small_43351292150_metrics.csv'},

        {'name': 'RegNet',
         'path': 'RegNetX_400MF_43351309875_metrics.csv'},

        {'name': 'ResNet',
         'path': 'ResNet50_43351341850_metrics.csv'},

        {'name': 'ShuffleNet',
         'path': 'ShuffleNet_V2_x1_0_43351380000_metrics.csv'},

        {'name': 'Swin_Transformer',
         'path': 'swin_tiny_patch4_window7_224_43351401200_metrics.csv'},

        {'name': 'VGG',
         'path': 'VGG16_43351425500_metrics.csv'},
    ]
